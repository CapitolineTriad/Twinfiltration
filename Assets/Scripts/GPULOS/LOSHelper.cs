...
namespace LOS
{
    ...
    public static class LOSHelper
    {
        ...
        /// </summary>
        public static bool CheckBoundsVisibility(LOSSource losSource, Bounds meshBounds, int layerMask, string seenByTag = "")
        {
            Camera currentCamera = losSource.SourceCamera;

            bool shouldCheckVisibility = seenByTag == "" || (seenByTag != "" && losSource.GameObject.tag == seenByTag);
            if (losSource.IsVisible && shouldCheckVisibility && currentCamera != null)
            {
